...
public abstract class AbstractDBOperator {
  ...
  /**
   * @param nextOperator the {@link AbstractDBOperator} to which the {@link GenericJoinExecutor}'s
  ...
  public void append(MatchQueryOutput matchQueryOutput) {
      throw new UnsupportedOperationException(this.getClass().getSimpleName() + " does not support"
          + " the append(MatchQueryOutput matchQueryOutputs) method.");
  }

  public void append(String stringQueryOutput) {
      throw new UnsupportedOperationException(this.getClass().getSimpleName() + " does not support"
          + " the append(String stringQueryOutput) method.");
  }
